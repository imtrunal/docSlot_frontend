...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | DocSlot - React.js Admin Dashboard Template"
        description="This is React.js Videos page for DocSlot - React.js Tailwind CSS Admin Dashboard Template"
      />
