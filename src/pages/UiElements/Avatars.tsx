...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | DocSlot - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for DocSlot - React.js Tailwind CSS Admin Dashboard Template"
      />
